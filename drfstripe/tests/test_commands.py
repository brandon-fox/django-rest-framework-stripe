...
class CommandTests(TestCase):
    ...
    @patch("stripe.Customer.retrieve")
    @patch("drfstripe.models.Customer.sync")
    @patch("drfstripe.models.Customer.sync_current_subscription")
    @patch("drfstripe.models.Customer.sync_invoices")
    @patch("drfstripe.models.Customer.sync_charges")
